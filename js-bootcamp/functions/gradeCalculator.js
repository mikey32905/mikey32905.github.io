...
const gradeCalc = function(studentScore, totalPossible) {
    if (typeof studentScore === 'number' && typeof totalPossible === 'number') {
        ...
        throw Error('You must enter a number for either student score and totalPossible!')
    }
}
...
try {
    ...
    console.log('Invalid value was entered.  Please be sure score values are numeric.')
}
